...
Wiki authoring 在写作或改稿前读取当前 Reality、正式指南和任务边界，形成简短起点简报，再进入 Plan/Challenge/Approval 约束下的正文写作。该过程不拥有事实，也不替代页面审查；能力边界见[运营文档知识能力](../../../internal Reality/operations-docs-system/capability/overview.md)。
